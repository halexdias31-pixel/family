...
const ACCEPTED_TAP = [
  ...
  + 'dropdowns.\n'
  + '        AND IT IS HALF THE ANSWER COLUMN NOW, WHICH IS THE LARGEST COMPROMISE ON THIS LIST. '
  + 'Asked for as *"i would like the grid to be half as wide"*. Ten hours across the full answer '
  + 'column was 18.5 / 23.1 / 24.4px a cell at 320 / 390 / 768; halved it is **8.8 / 11.1 / '
  + '11.8**, with a 1px gutter, so at 320 a fingertip covers about three columns at once. THAT IS '
  ...
  + 'their boxes (6.4px of ink in 8.8px at 320), nothing scrolls sideways, and the block week is '
  + 'untouched at 64 / 79.3 / 83.8 \u2014 `blk` is the class that keeps them apart.\n'
